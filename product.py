...
class productClass:
    def __init__(self, root):
        ...
        lbl_pid=Label(product_Frame, text="Product ID",bg="white", font=("goudy old style",20)).place(x=40,y=570)
        ...
        txt_pid=Entry(product_Frame, textvariable=self.var_pid,bg="light yellow", font=("goudy old style",15)).place(x=300,y=574,width=300, height=30)
        ...
        cmb_status.current(0)
         ...
         #==Button==#
        btn_add=Button(product_Frame, text="Add", command=self.add, font=("goudy old style",15),bg="#35ca4d",fg="black", cursor="hand2", relief=RIDGE).place(x=40,y=700,width=165,height=50)
        btn_update=Button(product_Frame, text="Update",command=self.update, font=("goudy old style",15),bg="#c9b3ff",fg="black", cursor="hand2", relief=RIDGE).place(x=210,y=700,width=165,height=50)
        btn_delete=Button(product_Frame, text="Delete",command=self.delete, font=("goudy old style",15),bg="#ff696f",fg="black", cursor="hand2", relief=RIDGE).place(x=380,y=700,width=165,height=50)
        btn_clear=Button(product_Frame, text="Clear",command=self.clear, font=("goudy old style",15),bg="#feff97",fg="black", cursor="hand2", relief=RIDGE).place(x=550,y=700,width=165,height=50)
        ...
        #==Optioms==#
        cmb_search=ttk.Combobox(SearchFrame, textvariable=self.var_searchby, values=("Select","Category","Supplier","Name", "pid"),state='readonly',justify=CENTER, font=("goudy old style",15))
